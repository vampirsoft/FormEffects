...
begin
  if
    ...
    (TCustomForm(WinControl).GetProtectedFormStyle = fsMDIChild) and
    IsWinXPUp                                                        and
    HasWindowRegion(Wnd)
  then
...
begin
  ...
  const ExStyle = WinControlWnd.GetWindowLongPtr(GWL_EXSTYLE);
...
begin
  ...
  begin
    ...
    TOleControl(WinControl).OleDraw(DC);
  end;
end;

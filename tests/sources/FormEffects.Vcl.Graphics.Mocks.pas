...
{ TCustomCanvas }
  ...
  TCustomCanvas = class abstract(TPersistent)
  public
...
{ TCanvas }
  ...
  TCanvas = class abstract(TCustomCanvas)
  strict private
    FPen: TPen;
  ...
  public
    ...
    procedure SetHandle(const Value: HDC); virtual; abstract;
...
begin
  ...
  begin
    const Picture = TPicture(Source);

    FOnChange := Picture.FOnChange;
    FGraphic  := Picture.FGraphic;
  end
  else

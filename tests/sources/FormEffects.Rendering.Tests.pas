...
{ TRenderingTests }
  ...
  {$ENDIF ~ USE_BILLENIUM_EFFECTS}
    procedure GetRegControl_for_Control_Test(const ExpectedFlags: DWORD;
    const ExpectNonClientCallback: Boolean = False;
    const ExpectClientCallback: Boolean = False); inline;
...
procedure TRenderingTests.CompleteFlags_should_return_flags_for_Form(const Focused: Boolean;
...
procedure TRenderingTests.CompleteFlags_should_return_flags_for_HintWindow(const Focused: Boolean;
  const Flags, Result: DWORD);
begin
...
procedure TRenderingTests.CompleteFlags_should_return_flags_for_TabDockPanel(const Focused: Boolean;
  const Flags, Result: DWORD);
begin
...
procedure TRenderingTests.CompleteFlags_should_return_flags_for_WinControl(const Focused: Boolean;
  const Flags, Result: DWORD);
begin
...
procedure TRenderingTests.GetRegControl_for_Control_Test(const ExpectedFlags: DWORD;
